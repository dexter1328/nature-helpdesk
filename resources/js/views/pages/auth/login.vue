<template>
    <form @submit.prevent="submit">
        ...
        <p class="text-gray-700 text-sm">
            Email Us for an query <a class="align-baseline font-bold text-blue-500 hover:text-blue-800" href="mailto:support@naturecheckout.com">support@naturecheckout.com</a>
        </p>
    </form>
</template>
