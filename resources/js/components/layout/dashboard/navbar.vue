        ...
        <div class="w-full px-4 flex justify-end">
            <div class="flex">
                <div class="ml-4 flex-1 flex items-center md:ml-6">
                    <a target="_blank" href="https://www.facebook.com/Naturecheckout" class="p-1 text-gray-400 rounded-full hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:shadow-outline focus:text-gray-500" aria-label="Notifications">
                       <svg-vue class="h-6 w-6 p-px" icon="font-awesome.facebook"></svg-vue>
                    </a>
                    <a target="_blank" href="https://www.instagram.com/naturecheckout" class="p-1 text-gray-400 rounded-full hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:shadow-outline focus:text-gray-500" aria-label="Notifications">
                       <svg-vue class="h-6 w-6 p-px" icon="font-awesome.instagram"></svg-vue>
                    </a>
                    <a target="_blank" href="https://twitter.com/naturecheckout" class="p-1 text-gray-400 rounded-full hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:shadow-outline focus:text-gray-500" aria-label="Notifications">
                       <svg-vue class="h-6 w-6 p-px" icon="font-awesome.twitter"></svg-vue>
                    </a>
